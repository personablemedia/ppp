						...
						<div class="dynamik-universal-design-controls dynamik-universal-design-border-controls">
							...
							<div class="dynamik-design-option dynamik-universal-design-border-controls" style="width:72%;">
								<p class="bg-box-design">
									...
									<input type="text" class="color {pickerFaceColor:'#FFFFFF'} color-box dynamik-universal-master-control" id="dynamik-universal-border-color" name="universal_border_color" value="universal_border_color" />
								</p>
							</div>
						</div>
					</div>
